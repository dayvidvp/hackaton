# KB — F&O Hive   Add new company

**Systeem:** Pollet Group IT
**Bron:** Automatisch geconverteerd van `F&O Hive - Add new company.docx`
...
> ![Afbeelding met tekst, schermopname, scherm, software Door AI gegenereerde inhoud is mogelijk onjuist.](media/image1.png){width="2.394523184601925in" height="3.055080927384077in"}
...
![Afbeelding met tekst, schermopname, Lettertype, nummer Door AI gegenereerde inhoud is mogelijk onjuist.](media/image2.png){width="2.9777176290463694in" height="1.280738188976378in"}

Corrected:

![Afbeelding met tekst, schermopname, Lettertype, nummer Door AI gegenereerde inhoud is mogelijk onjuist.](media/image3.png){width="2.8260301837270343in" height="1.4227602799650043in"}
...
![Afbeelding met tekst, nummer, software, Lettertype Door AI gegenereerde inhoud is mogelijk onjuist.](media/image4.png){width="6.268055555555556in" height="2.4243055555555557in"}
...
![Afbeelding met schermopname, tekst, nummer, lijn Door AI gegenereerde inhoud is mogelijk onjuist.](media/image5.png){width="6.268055555555556in" height="3.4458333333333333in"}
...
![](media/image6.png){width="6.268055555555556in" height="0.66875in"}
...
![Afbeelding met tekst, schermopname, Lettertype Door AI gegenereerde inhoud is mogelijk onjuist.](media/image7.png){width="3.475300743657043in" height="1.3917869641294838in"}
...
![Afbeelding met tekst, schermopname, Lettertype Door AI gegenereerde inhoud is mogelijk onjuist.](media/image8.png){width="3.8253313648293963in" height="1.408455818022747in"}
...
For the time being, the pricing groups and discounts have to be set by a hive administrator. Please use the created forms.

- If you need to complete the pricing group & discount group for a **[subdistributor]{.underline}**: use this link: <https://forms.office.com/e/S5Batfd2Av>

- If you need to complete the pricing group & discount group for a **[distributor]{.underline}**: use this link: <https://forms.office.com/e/ydH3HB8RYq>

- If you want to modify information from a distributor or subdistributor, please use this link: <https://forms.office.com/e/cbqXXJ5xN0>

You will need the Hive-link to submit the form. You can find the (Sub) distributor link here:

Example:<https://app.hivecpq.com/#/companies/d11c5a1323ed4b789238e168b803803b?companyA=MyAquadeck>
